...
public class ModFeatures {
    ...
    public static final class Configs {
        ...
        public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> CHERRY_TREE_CONFIG = register("cherry_tree", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ModFeatures.States.OAK_LOG), new SimpleBlockStateProvider(States.CHERRY_BLOSSOM_LEAVES), new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayerFeature(1, 0, 1))).setIgnoreVines().build()));
        ...
        public static final ConfiguredFeature<BaseTreeFeatureConfig, ?> BIG_CHERRY_TREE_CONFIG = register("big_cherry_tree", Feature.TREE.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.OAK_LOG), new SimpleBlockStateProvider(States.CHERRY_BLOSSOM_LEAVES), new FancyFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(4), 4), new FancyTrunkPlacer(3, 11, 0), new TwoLayerFeature(0, 0, 0, OptionalInt.of(4)))).setIgnoreVines().func_236702_a_(Heightmap.Type.MOTION_BLOCKING).build()));
